...
public:  
    ...
    MOCK_METHOD3(showInfoBox, void (QWidget *parent,
                                    const QString &title,
                                    const QString &text));

    MOCK_METHOD3(showWarning, void (QWidget *parent,
                                    const QString &title,
                                    const QString &text));

    MOCK_METHOD3(showQuestion, QMessageBox::StandardButton (QWidget *parent,
                                                            const QString &title,
                                                            const QString &text));
